...
- ⚡ **Zero-Dependency Static Performance**: Built purely with HTML5, Vanilla CSS, and JavaScript for instantaneous load speeds.
...
└── poornesh_resume.pdf  # Official resume document
```
...
- **Styling**: Vanilla CSS3 (Custom Variables, Flexbox, Grid, Glassmorphism, CSS Animations)
- **Scripting**: Modern ES6+ JavaScript & HTML5 Canvas API
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/PoorneshGowda21/Portfolio.git
   cd Portfolio
   ```
...
- **Email**: [prurneshgowda@gmail.com](mailto:prurneshgowda@gmail.com)
- **LinkedIn**: [linkedin.com/in/poornesh-gowda-g-y-a6ab41331](https://linkedin.com/in/poornesh-gowda-g-y-a6ab41331)
- **GitHub**: [github.com/PoorneshGowda21](https://github.com/PoorneshGowda21)
- **Phone**: [+91 7019298140](tel:+917019298140)

---

*Designed & Built by Poornesh Gowda G Y © 2026*
